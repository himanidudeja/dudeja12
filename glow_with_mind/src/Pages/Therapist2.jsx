...
<div className="max-w-3xl mx-auto p-4">
      ...
      <div className="bg-white shadow-md p-4 rounded-xl mb-6">
        <h2 className="text-xl font-semibold text-green-700 mb-1">Rhon</h2>
        <p className="text-sm text-gray-600 mb-2">
          MA Psychology, Certified PCT Practitioner, Completed CBT Training program from Beck-institute (USA) | 3 Years Experience
        </p>
        <p className="text-sm text-gray-600">
          Rhon is a mental health advocate and counsellor experienced in supporting individuals dealing with anxiety, stress, depression, and relationship issues.
        </p>
      </div>
