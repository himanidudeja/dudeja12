  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="bg-white shadow-md p-4 rounded-xl mb-6">
        <h2 className="text-xl font-semibold  text-green-700 mb-1">Aashi Agarwal</h2>
        <p className="text-sm text-gray-600 mb-2">
          MA Psychology|2 Years Experience
        </p>
        <p className="text-sm text-gray-600">
        Aashi Agarwal is a mental health advocate and counsellor experienced in supporting individuals dealing with anxiety, stress, depression, and relationship issues.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["10:00 AM", "01:30 PM", "06:00 PM"].map((slot, index) => (
                <button
                  key={index}
                  type="button"
